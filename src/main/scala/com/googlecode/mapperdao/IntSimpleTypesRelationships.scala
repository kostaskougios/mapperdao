...
protected class IntEntityOTM(table: String, fkColumn: String, soleColumn: String)
		extends Entity[NoId, IntValue](table, classOf[IntValue]) {
...
class IntEntityManyToManyAutoGenerated(table: String, pkColumn: String, soleColumn: String, sequence: Option[String] = None) extends IntEntityManyToManyBase[SurrogateIntId](table, soleColumn) {
