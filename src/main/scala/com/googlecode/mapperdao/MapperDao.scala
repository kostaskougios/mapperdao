...
trait MapperDao {
	 ...
	 */
	def insert[ID, T](entity: Entity[ID, T], o: T): T with DeclaredIds[ID] = insert(defaultUpdateConfig, entity, o)
	 ...
	 * @see		#insert(entity,o)
	 */
	def insert[ID, T](updateConfig: UpdateConfig, entity: Entity[ID, T], o: T): T with DeclaredIds[ID] = {
	 ...
	 */
	def update[ID, T](entity: Entity[ID, T], o: T with DeclaredIds[ID]): T with DeclaredIds[ID] = update(defaultUpdateConfig, entity, o)
	 ...
	 * @see		#update(entity,o)
	 */
	def update[ID, T](updateConfig: UpdateConfig, entity: Entity[ID, T], o: T with DeclaredIds[ID]): T with DeclaredIds[ID] = {
		if (o == null) throw new NullPointerException("o can't be null")
	 ...
	 */
	def update[ID, T](entity: Entity[ID, T], o: T with DeclaredIds[ID], newO: T): T with DeclaredIds[ID] =
	...
	def merge[ID, T](
		...
		o: T,
		id: ID
	): T with DeclaredIds[ID] = merge(defaultSelectConfig, defaultUpdateConfig, entity, o, id)
	 ...
	 *                    exists.
	 */
	def select[ID, T](entity: Entity[ID, T], id: ID): Option[T with DeclaredIds[ID]] = select(defaultSelectConfig, entity, id)
	 ...
	 */
	def select[ID, T](selectConfig: SelectConfig, entity: Entity[ID, T], id: ID): Option[T with DeclaredIds[ID]]
