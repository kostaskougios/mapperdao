...
trait MapperDao {
	 ...
	 */
	def insert[ID,PC, T](entity: Entity[ID,PC, T], o: T): T with PC = insert(defaultUpdateConfig, entity, o)
	 ...
	 * @see		#insert(entity,o)
	 */
	def insert[ID,PC, T](updateConfig: UpdateConfig, entity: Entity[ID,PC, T], o: T): T with PC= {
		if (o == null) throw new NullPointerException("o can't be null")
		insertBatch(updateConfig, entity, o :: Nil).head
	}

	def insertBatch[ID,PC, T](
	 ...
	 */
	def update[ID,PC, T](entity: Entity[ID,PC, T], o: T with PC): T with PC = update(defaultUpdateConfig, entity, o)
	 ...
	 * @see		#update(entity,o)
	 */
	def update[ID,PC, T](updateConfig: UpdateConfig, entity: Entity[ID,PC, T], o: T with PC): T with PC = {
		if (o == null) throw new NullPointerException("o can't be null")
	 ...
	 * methods.
	 */
	def updateBatchMutable[ID,PC, T](
		entity: Entity[ID,PC, T],
		os: List[T with PC]
	 ...
	 */
	def update[ID,PC, T](entity: Entity[ID,PC, T], o: T with PC, newO: T): T with PC =
	...
	protected def select0[ID, T](selectConfig: SelectConfig, entity: Entity[ID,_, T], id: ID): Option[T with Persisted]
