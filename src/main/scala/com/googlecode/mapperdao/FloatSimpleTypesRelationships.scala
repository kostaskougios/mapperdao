...
class FloatEntityManyToManyAutoGenerated(table: String, pkColumn: String, soleColumn: String, sequence: Option[String] = None) extends FloatEntityManyToManyBase[SurrogateIntId](table, soleColumn) {
