 ...
 *         6 Sep 2012
 */
case class SqlFunctionValue[R](name: String, values: List[Any], schema: Option[Schema] = None)
{
 ...
 */
protected class SqlFunctionValue1[V1, R](name: String, schema: Option[Schema])
{
	def apply(v1: SqlFunctionArg[V1]) = SqlFunctionValue[R](name, List(v1.v), schema)
}

/**
 * function with 2 parameters
 */
protected class SqlFunctionValue2[V1, V2, R](name: String, schema: Option[Schema])
{
	def apply(
		v1: SqlFunctionArg[V1],
		v2: SqlFunctionArg[V2]
		) =
		SqlFunctionValue[R](name, List(v1.v, v2.v), schema)
}

/**
 * function with 3 parameters
 */
protected class SqlFunctionValue3[V1, V2, V3, R](name: String, schema: Option[Schema])
{
	def apply(
		v1: SqlFunctionArg[V1],
		v2: SqlFunctionArg[V2],
		...
		SqlFunctionValue[R](name, List(v1.v, v2.v, v3.v), schema)
}

/**
 * function with 4 parameters
 */
protected class SqlFunctionValue4[V1, V2, V3, V4, R](name: String, schema: Option[Schema])
{
	def apply(
		v1: SqlFunctionArg[V1],
		v2: SqlFunctionArg[V2],
		...
		SqlFunctionValue[R](name, List(v1.v, v2.v, v3.v, v4.v), schema)
}

/**
 * function with 5 parameters
 */
protected class SqlFunctionValue5[V1, V2, V3, V4, V5, R](name: String, schema: Option[Schema])
{
	def apply(
		v1: SqlFunctionArg[V1],
		v2: SqlFunctionArg[V2],
		...
		SqlFunctionValue[R](name, List(v1.v, v2.v, v3.v, v4.v, v5.v), schema)
}
