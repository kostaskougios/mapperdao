...
object CommonEntities {
	...
	object OwnerEntity extends Entity[SurrogateIntId, Owner] {
		val id = key("id") sequence (Setup.database match {
	...
	object WifeEntity extends Entity[SurrogateIntId, Wife] {
		val id = key("id") sequence (Setup.database match {
	...
	object ImageEntity extends Entity[SurrogateIntId, Image] {
		val id = key("id") sequence (Setup.database match {
