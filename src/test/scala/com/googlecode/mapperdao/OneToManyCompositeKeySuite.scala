...
class OneToManyCompositeKeySuite extends FunSuite with ShouldMatchers {
	...
	object HouseEntity extends Entity[SurrogateIntAndNaturalStringId, House] {
		...
		def constructor(implicit m) = new House(address, doors) with SurrogateIntAndNaturalStringId {
