...
class OneToManyLazyLoadSuite extends FunSuite with Matchers
{
	...
	object CarEntity extends Entity[Int, SurrogateIntId, Car]
	{
		...
		def constructor(implicit m) = new Car(model) with Stored
		{
	...
	object PersonEntity extends Entity[Int, SurrogateIntId, Person]
	{
		...
		def constructor(implicit m) = new Person(name, owns, cars) with Stored
		{
