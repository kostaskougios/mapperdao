...
class OneToManyAutoGeneratedSuite extends FunSuite
{
...
object OneToManyAutoGeneratedSuite
{
	...
	object JobPositionEntity extends Entity[Int, SurrogateIntId, JobPosition]
	{
		...
		def constructor(implicit m: ValuesMap) = new JobPosition(name, rank) with Stored
		{
	...
	object PersonEntity extends Entity[Int, SurrogateIntId, Person]
	{
		...
		def constructor(implicit m: ValuesMap) = new Person(name, surname, owns, age, m(jobPositions).toList.sortWith(_.name < _.name)) with Stored
		{
