...
object ManyToManyAutoGeneratedSuite {
	...
	object ProductEntity extends Entity[IntId, SurrogateIntId, Product] {
	...
	object AttributeEntity extends Entity[IntId, SurrogateIntId, Attribute] {
		...
		def constructor(implicit m) = new Attribute(name, value, products) with SurrogateIntId {
