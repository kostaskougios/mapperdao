...
class SimpleQuerySuite extends FunSuite with Matchers
{
	...
	def q10 = select from jpe where jpe.start > DateTime.now.plusDays(0) and jpe.start < DateTime.now.plusDays(3).minusSeconds(60)
