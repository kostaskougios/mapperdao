...
class QueryAutogeneratedSuite extends FunSuite with Matchers
{

	implicit val (jdbc: Jdbc, mapperDao: MapperDao, queryDao: QueryDao) = Setup.setupMapperDao(List(ComputerEntity, CompanyEntity))
	...
	object ComputerEntity extends Entity[Int, SurrogateIntId, Computer]
	{
		...
		def constructor(implicit m: ValuesMap) = new Computer(name, company) with Stored
		{
